...
# Set up webhook for cda-datasets bucket
webhook_url="http://cda-datasets-webhook:5011/webhook"  # Replace with your actual Flask app URL
mc admin config set myminio notify_webhook:1 endpoint="${webhook_url}" event="put" enable="on"
